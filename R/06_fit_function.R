#' BCS-NSM Marginal Regression Models for Positive Continuous Data
#'
...
#' @param margin a character which specifies the marginal Box-Cox symmetric (BCS) distribution.
                      ...
                      control = control_fit(...), ...)
{
  ...
  ## Fit
  out <- mr_mle(y, X, Z, association, mu.link, sigma.link, copula, eta, margin, control)
